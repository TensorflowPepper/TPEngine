...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	function addSongUI():Void
	{
		...
		var characters:Array<String> = CoolUtil.coolTextFile(Paths.modTxtWithoutPath('characterList'));
		var gfVersions:Array<String> = CoolUtil.coolTextFile(Paths.modTxtWithoutPath('gfVersionList'));
		var stages:Array<String> = CoolUtil.coolTextFile(Paths.modTxtWithoutPath('stageList'));
		var noteStyles:Array<String> = CoolUtil.coolTextFile(Paths.modTxtWithoutPath('noteStyleList'));
	...
	function updateGrid():Void
	{
		...
		else
		{
			...
			for (i in 0...curSection)
				if (_song.notes[i].changeBPM)
					daBPM = _song.notes[i].bpm;
			Conductor.changeBPM(Std.int(daBPM));
		}
