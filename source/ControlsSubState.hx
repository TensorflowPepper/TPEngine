...
class ControlsSubState extends FlxSubState
{
	...
	{	
		...
		keyTextDisplay.setFormat("ONE Mobile POP", 42, FlxColor.WHITE, FlxTextAlign.CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		infoText.setFormat("ONE Mobile POP", 24, FlxColor.WHITE, FlxTextAlign.CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
